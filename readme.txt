This program contains Matlab programs for the nearest-neighbor cluster analysis. You only need to
...
(which is also attached). Please start by running the eq_cluster.m with no changes (just edit the catalog directory
in line 101) to make sure it works on your side.
